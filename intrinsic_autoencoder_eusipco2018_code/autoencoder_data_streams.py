...
# no idea which of these we actually need - will uncomment in the end
...
# will be converted to grayscale, color probably useless
class dataset:
  ...
  def __init__(self, filename, subsets={ 'validate' : 0.0, 'train': 1.0 }, max_examples=1e20, min_example=0, random_shuffle=True ):
    ...
    # let's hope this is thread-safe ...
